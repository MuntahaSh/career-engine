...
<div class="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm" id="add-skill-modal">
    <div class="bg-surface w-full max-w-md mx-4 rounded-xl shadow-md overflow-hidden border border-outline-variant">
        <div class="p-lg border-b border-outline-variant flex justify-between items-center">
            <h3 class="text-headline-h4 font-headline-h4 text-on-surface">Add New Skill</h3>
            <button class="p-sm hover:bg-surface-container-high rounded-full transition-colors">
                <span class="material-symbols-outlined">close</span>
            </button>
        </div>
        <div class="p-lg space-y-lg">
            <div class="space-y-xs">
                <label class="text-body-sm font-bold text-on-surface-variant">Skill Name</label>
                <input
                    class="w-full px-md py-sm bg-surface-container-low border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-fixed transition-all"
                    placeholder="e.g., Python, UX Design" type="text" />
            </div>
            <div class="space-y-xs">
                <label class="text-body-sm font-bold text-on-surface-variant">Category</label>
                <select
                    class="w-full px-md py-sm bg-surface-container-low border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-fixed transition-all">
            ...
            <div class="space-y-md">
                <div class="flex justify-between items-center">
                    <label class="text-body-sm font-bold text-on-surface-variant">Proficiency Level (%)</label>
                    <span class="text-label-mono font-label-mono text-primary">85%</span>
                </div>
                <input
                    class="w-full h-2 bg-surface-container-highest rounded-lg appearance-none cursor-pointer accent-primary"
                    max="100" min="0" type="range" value="85" />
            </div>
        </div>
        <div class="p-lg bg-surface-container-low flex justify-end gap-md">
            <button
                class="px-lg py-sm text-body-sm font-bold text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-colors">Cancel</button>
            <button
                class="px-lg py-sm bg-primary text-on-primary rounded-lg font-bold text-body-sm hover:opacity-90 transition-all active:scale-95">Add
                Skill</button>
        </div>
    </div>
</div>
